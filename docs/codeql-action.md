# How to use `Customizations.qll` file into Github CodeQL Action

## Usage

You only need to add this Action between the Initialize CodeQL stage and Build/Analysis stages
